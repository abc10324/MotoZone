    ...
    $.fn.twaddress = function () {
        this
            .each(function () {
                ...
                var $twcity = $('<select name="city"></select>');
                var $twmore = $('<input name="address" type="text"></input>');
                for (var i = 0; i < city_list.length; i++) {
                    if ($inputbox.val().indexOf(city_list[i].name) >= 0) {
                        options.city = city_list[i].name;
                        $inputbox.val($inputbox.val().replace(
                            city_list[i].name, ""));
                    }
                }
                var mx_len = 0;
                ...
                $inputbox
                    .val($inputbox.val().replace(options.dist, ""));
                ...
                $twcity
                    .change(function () {
                        var $new_twdist = $('<select name="townShip"></select>');
                        ...
                        for (var i = 0; i < dist_list.length; i++) {
                            if (dist_list[i].city == $twcity.val()) {
                                if (options != undefined
                                    ...
                                    && fisttimeflag
                                    && dist_list[i].name == options.dist) {
                                    $new_twdist
                                        .append('<option value="' + dist_list[i].pinyin + '" selected="selected">'
                                            + dist_list[i].name
                                            + '</option>');
                                    fisttimeflag = false;
                                } else {
                                    $new_twdist
                                        .append('<option value="' + dist_list[i].pinyin + '">'
                                            + dist_list[i].name
                                            + '</option>');
                                }
                            }
                ...
                for (var i = 0; i < city_list.length; i++) {
                    if (options != undefined
                        ...
                        && city_list[i].name == options.city) {
                        $twcity
                            .append('<option value="' + city_list[i].pinyin + '" selected="selected">'
                                + city_list[i].name
                                + '</option>');
                    } else {
                        $twcity
                            .append('<option value="' + city_list[i].pinyin + '">'
                                + city_list[i].name
                                + '</option>');
                    }
                }
        ...
        function getValue(city, dist, more, o) {
            ...
            for (var i = 0; i < dist_list.length; i++) {
                if (dist_list[i].city == city.val()
                    && dist_list[i].pinyin == dist.val()) {
